...
namespace APICatalogo.Migrations
{
    public partial class Populadb : Migration
    {
        ...
        {
            mb.Sql("Insert into Categorias(Nome, ImagemUrl) Values('Bebidas','http://www.jimmy.net/Imagens/1.jpg')");
            mb.Sql("Insert into Categorias(Nome, ImagemUrl) Values('Lanches','http://www.jimmy.net/Imagens/2.jpg')");
           ...
           "Values('Coca-Cola Diet','Refrigerante de Cola 350 ml',5.45,'http://www.jimmy.net/Imagens/coca.jpg',50,GETDATE(),(Select CategoriaId from Categorias where Nome='Bebidas'))");
            ...
            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque,DataCadastro,CategoriaId) " +
                                "Values('Pudim 100 g','Pudim de leite condensado 100g',6.75,'http://www.jimmy.net/Imagens/pudim.jpg',20,GETDATE(),(Select CategoriaId from Categorias where Nome='Sobremesas'))");
        }
